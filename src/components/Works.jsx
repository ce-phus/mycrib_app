...
import { homeUI, homeUIwhite, exploreUI, commentUI } from '../assets';
...
const Works = () => {
  return (
    <Section id="features">
      ...
      <div className='max-w-[77.5rem] mx-auto px-5 md:px-10 lg:px-15 xl:max-w-[87.5rem] lg:pt-20 pt-10 xl:pt-64'>
        <div className='flex flex-col flex-col-reverse lg:flex-row gap-2 lg:ga-5 xl:gap-20'>
          <div className='space-y-4'>
            <h1 className='text-[1.75rem] leading-[2.5rem] md:text-[2rem] md:leading-[2.5rem] lg:text-[2.5rem] lg:leading-[3.5rem] xl:text-[3rem] xl:leading-tight text-black font-medium'>Post</h1>

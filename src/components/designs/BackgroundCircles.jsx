...
export const BottomLine = () => {
  ...
  const Rings = () => {
    return (
      <>
        <div className="absolute top-1/2 left-1/2 w-[65.875rem] aspect-square border border-[#CAC6DD]/70 rounded-full -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute top-1/2 left-1/2 w-[51.375rem] aspect-square border border-[#CAC6DD]/70 rounded-full -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute top-1/2 left-1/2 w-[36.125rem] aspect-square border border-[#CAC6DD]/70 rounded-full -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute top-1/2 left-1/2 w-[23.125rem] aspect-square border border-[#CAC6DD]/70 rounded-full -translate-x-1/2 -translate-y-1/2" />
      </>
    );
  };
